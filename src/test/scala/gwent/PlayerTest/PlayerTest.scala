...
package gwent.PlayerTest

/**
 * PlayerTest
 *
 * Tests para la clase Player que representa jugadores tanto humanos como no
 *
 * @author Hugo Diaz
 * @since 1.1.0
 * @version 2.1.0
